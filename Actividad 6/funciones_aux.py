...
def create_packet(parsed_IP_packet: dict) -> bytes:
    ...
    id_bytes = parsed_IP_packet["id"]

    #Convertir el offset a bytes
    offset_bytes = parsed_IP_packet["offset"]

    #Convertir el size a bytes
    size_bytes = parsed_IP_packet["size"]

    #Convertir el flag a bytes
    flag_bytes = parsed_IP_packet["flag"]
    ...
    packet = destination_ip_bytes + destination_port_bytes + ttl_bytes + id_bytes + offset_bytes + size_bytes + flag_bytes + message_bytes
